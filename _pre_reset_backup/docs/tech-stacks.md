...
| Cloud      | **Firebase-ESP-Client** v4.4.17 (Mobizt) — gateway only | Async Firebase Realtime Database REST client (setJSON, beginStream, readStream) |
...
ESP-NOW, Firebase-ESP-Client, WiFiManager, sensors, SSR, WeatherAPI, ESP32
